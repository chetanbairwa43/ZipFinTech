                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 listViewclr">  
                                        <h6 class="fw-bolder">Tax 1 (%)</h6>
                                        <p class="mb-0">{{ (isset($data) && isset($data->tax)) ? $data->tax->title.' '.$data->tax->tax_percent.' %' : ((isset($data->category) && isset($data->category->tax)) ? $data->category->tax->title.' '.$data->category->tax->tax_percent.' %' : '-')}}</p>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="p-3 listViewclr">  
                                        <h6 class="fw-bolder">Tax 2 (%)</h6>
                                        <p class="mb-0">{{ (isset($data) && isset($data->tax2)) ? $data->tax2->title.' '.$data->tax2->tax_percent.' %' : '-' }}</p>
                                    </div>
                                </div>
