                        ...
                        <div class="right-item d-flex justify-content-end">
                            <form action="" method="GET" class="d-flex">
                                ...
                                <input type="text" name="keyword" id="keyword" class="form-control"
                                    value="{{ request()->keyword }}" placeholder="Search" required>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true">Zip To Zip</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                            type="button" role="tab" aria-controls="profile" aria-selected="false">Bank Transafar</button>
                    </li>
                </ul>
                            ...
                            <div class="card-header ">
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 mt-auto">
                                        <h5>Zip to zip transaction list</h5>
                                    </div>
                                ...
                                <div class="table">
                                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        <tr data-entry-id="{{ $value->id }}">
                                            ...
                                            <td>{{ $value->amount ?? '' }}</td>
                                            <td
                                                class="{{($value->transaction_type == 'cr')?'text-success':'text-danger'}}">
                                                {{ ($value->transaction_type == 'cr')? 'Credit':'Debit' }}</td>
                                            <td>{{ ucfirst($value->transaction_about) ?? "-" }}</td>
                                            <td>{{$value->receiver->fname ?? "" }} {{$value->receiver->lname ?? "" }}</td>
                                            <td>{{ \Carbon\Carbon::parse($value->created_at)->format('d F, Y') ?? '' }}
                                            </td>
                                            <td class="text-center">
                                                ...
                                                {{-- <button type="submit" class="btn btn-sm btn-icon p-1 delete-record"
                                                    route="{{ route('admin.tDelete', $value->id) }}"><i
                                                        class="mdi mdi-delete" data-bs-toggle="tooltip"
