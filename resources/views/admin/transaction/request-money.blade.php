                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                            type="button" role="tab" aria-controls="profile" aria-selected="false">From others</button>
                    </li>
                </ul>
                            ...
                            <div class="card-body">
                                <div class="table">
                                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        @foreach($ztozreqest as $key => $value)
                                        <tr data-entry-id="{{ $value->id }}">
                                            <td>{{ $i++ ?? ''}}</td>
                                            <td>{{ $value->moneyResciever->fname ?? ''}} {{$value->moneyResciever->lname ?? ''}}
                                            </td>
                                            <td>{{ ($value->payer->fname ?? '') .' '.($value->payer->lname ?? '')}}</td>
                                            <td>{{ $value->amount ?? '' }}</td>
