        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.domain-setting.store') }}" method="POST" enctype="multipart/form-data" id="basic-form">
                            @csrf

                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="name" class="mt-2"> System Update <span class="text-danger">*</span></label>
                                    <input type="text" name="system_update" class="form-control @error('system_update') is-invalid @enderror" placeholder="System Update" value="{{ old('system_update', isset($data) && isset($data['system_update']) ? $data['system_update'] : '' ) }}" required>
                                    @error('app_version')
